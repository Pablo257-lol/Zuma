...
data = r"C:\Users\biruk\PycharmProjects\Test Game\text.txt"
pack1 = False
pack2 = False

def button(frame, btn_font, frame3, frame1_2, frame2):
    ...
    btn_3 = Button(frame, font=btn_font, text= "Результаты", command=lambda :farther(frame, frame2, btn_font, frame3, frame1_2))
...
def save_text(entry, frame, frame1_2, label):
    if len(entry.get()) >= 8:
...
def farther(frame, frame2, btn_font, frame3, frame1_2):
    global pack2
    if pack2:
        frame2.pack_forget()
        frame.pack(fill=BOTH, expand=True)
        button(frame, btn_font, frame3, frame1_2, frame2)
        pack2 = False
    else:
        frame.pack_forget()
...
def init_app_two(win):
    ...
    btn1_1 = Button(frame1_2, font= btn_font, text= "Продолжить", command=lambda: save_text(entry, frame, frame1_2, label))
    ...
    btn1_3 = Button(frame3, font= btn_font, text= 'Главное меня', command=lambda :farther(frame, frame2, btn_font, frame3, frame1_2))
    ...
    map_logo.pack()
    button2 = Button(frame2, font= btn_font, text="Главное меню", command=lambda: farther(frame, frame2, btn_font, frame3, frame1_2))
